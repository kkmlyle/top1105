...
wire   [0:0] final_out_re_last_V_fu_176_p2;
reg   [0:0] final_out_re_last_V_reg_237;
wire   [63:0] zext_ln125_fu_192_p1;
reg   [13:0] i_fu_72;
wire   [13:0] i_2_fu_164_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_i_1;
reg   [0:0] tmp_last_V_fu_76;
reg   [0:0] tmp_last_V_1_fu_80;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln122_fu_170_p2 == 1'd0) & (icmp_ln120_fu_158_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        final_out_re_last_V_reg_237 <= final_out_re_last_V_fu_176_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln122_fu_170_p2 == 1'd0) & (icmp_ln120_fu_158_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_1_fu_80 <= final_out_re_last_V_fu_176_p2;
        tmp_last_V_fu_76 <= final_out_re_last_V_fu_176_p2;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_146)) begin
        if ((icmp_ln122_reg_233 == 1'd1)) begin
            cp_outim_TLAST = tmp_last_V_1_fu_80;
        end else if ((icmp_ln122_reg_233 == 1'd0)) begin
            cp_outim_TLAST = final_out_re_last_V_reg_237;
        end else begin
            cp_outim_TLAST = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_146)) begin
        if ((icmp_ln122_reg_233 == 1'd1)) begin
            cp_outre_TLAST = tmp_last_V_fu_76;
        end else if ((icmp_ln122_reg_233 == 1'd0)) begin
            cp_outre_TLAST = final_out_re_last_V_reg_237;
        end else begin
            cp_outre_TLAST = 'bx;
        end
    end else begin
...
assign final_out_re_last_V_fu_176_p2 = ((ap_sig_allocacmp_i_1 == 14'd16351) ? 1'b1 : 1'b0);
