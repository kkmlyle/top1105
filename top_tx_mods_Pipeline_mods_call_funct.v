...
reg[15:0] temp1_re500_din;
reg temp1_re500_write;
reg[15:0] temp1_im501_din;
...
wire   [15:0] grp_qpsk_fu_234_temp1_re500_din;
wire    grp_qpsk_fu_234_temp1_re500_write;
wire   [15:0] grp_qpsk_fu_234_temp1_im501_din;
wire    grp_qpsk_fu_234_temp1_im501_write;
...
wire   [15:0] grp_qam16_fu_248_temp1_re500_din;
wire    grp_qam16_fu_248_temp1_re500_write;
wire   [15:0] grp_qam16_fu_248_temp1_im501_din;
wire    grp_qam16_fu_248_temp1_im501_write;
wire    grp_qam64_fu_268_ap_start;
wire    grp_qam64_fu_268_ap_done;
wire    grp_qam64_fu_268_ap_idle;
wire    grp_qam64_fu_268_ap_ready;
wire   [15:0] grp_qam64_fu_268_temp1_re500_din;
wire    grp_qam64_fu_268_temp1_re500_write;
wire   [15:0] grp_qam64_fu_268_temp1_im501_din;
wire    grp_qam64_fu_268_temp1_im501_write;
...
top_tx_qpsk grp_qpsk_fu_234(
    ...
    .temp1_re500_din(grp_qpsk_fu_234_temp1_re500_din),
    .temp1_re500_full_n(temp1_re500_full_n),
    .temp1_re500_write(grp_qpsk_fu_234_temp1_re500_write),
    .temp1_im501_din(grp_qpsk_fu_234_temp1_im501_din),
    .temp1_im501_full_n(temp1_im501_full_n),
    .temp1_im501_write(grp_qpsk_fu_234_temp1_im501_write),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .input2_ap_vld(1'b1),
    .input1_ap_vld(1'b1),
...
top_tx_qam16 grp_qam16_fu_248(
    ...
    .temp1_re500_din(grp_qam16_fu_248_temp1_re500_din),
    .temp1_re500_full_n(temp1_re500_full_n),
    .temp1_re500_write(grp_qam16_fu_248_temp1_re500_write),
    .temp1_im501_din(grp_qam16_fu_248_temp1_im501_din),
    .temp1_im501_full_n(temp1_im501_full_n),
    .temp1_im501_write(grp_qam16_fu_248_temp1_im501_write)
);
...
top_tx_qam64 grp_qam64_fu_268(
    ...
    .temp1_re500_din(grp_qam64_fu_268_temp1_re500_din),
    .temp1_re500_full_n(temp1_re500_full_n),
    .temp1_re500_write(grp_qam64_fu_268_temp1_re500_write),
    .temp1_im501_din(grp_qam64_fu_268_temp1_im501_din),
    .temp1_im501_full_n(temp1_im501_full_n),
    .temp1_im501_write(grp_qam64_fu_268_temp1_im501_write)
);
...
always @ (*) begin
    if ((((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1)))) begin
...
always @ (*) begin
    if (((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (icmp_ln119_fu_298_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (icmp_ln119_fu_298_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        if ((1'b1 == ap_condition_230)) begin
            ...
            input1_buff_V_address0 = i_5_cast_fu_310_p1;
        end else begin
...
always @ (*) begin
    if (((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge193 == 1'd0) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge191 == 1'd0) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge189 == 1'd0) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        if ((1'b1 == ap_condition_230)) begin
            ...
            input2_buff_V_address0 = i_5_cast_fu_310_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_372)) begin
        if (((brmerge193 == 1'd0) & (brmerge191 == 1'd1))) begin
            ...
            input3_buff_V_address0 = i_5_cast_fu_310_p1;
        end else begin
...
always @ (*) begin
    if (((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge193 == 1'd0) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | (~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge191 == 1'd0) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_372)) begin
        if (((brmerge193 == 1'd0) & (brmerge191 == 1'd1))) begin
            ...
            input4_buff_V_address0 = i_5_cast_fu_310_p1;
        end else begin
...
always @ (*) begin
    if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((brmerge193 == 1'd1) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (ap_predicate_op50_write_state2 == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        temp1_im501_din = 16'd0;
...
always @ (*) begin
    if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (ap_predicate_op49_write_state2 == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        temp1_re500_din = 16'd0;
    end else if (((ap_predicate_op60_call_state4 == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        temp1_re500_din = grp_qam64_fu_268_temp1_re500_din;
    end else if (((ap_predicate_op58_call_state4 == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        temp1_re500_din = grp_qam16_fu_248_temp1_re500_din;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (icmp_ln119_fu_298_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge193 == 1'd1) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge193 == 1'd0) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge191 == 1'd0) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else if ((~(((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1))) & (brmerge189 == 1'd0) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = (((temp1_im501_full_n == 1'b0) & (ap_predicate_op50_write_state2 == 1'b1)) | ((temp1_re500_full_n == 1'b0) & (ap_predicate_op49_write_state2 == 1'b1)));
end
...
always @ (*) begin
    ap_condition_372 = ((brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2));
end

always @ (*) begin
    ap_predicate_op49_write_state2 = ((brmerge193 == 1'd1) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op50_write_state2 = ((brmerge193 == 1'd1) & (brmerge191 == 1'd1) & (brmerge189 == 1'd1) & (icmp_ln119_fu_298_p2 == 1'd0));
end
...
assign input1_buff_V_addr_1_gep_fu_134_p3 = i_5_cast_fu_310_p1;

assign input1_buff_V_addr_2_gep_fu_176_p3 = i_5_cast_fu_310_p1;

assign input2_buff_V_addr_1_gep_fu_142_p3 = i_5_cast_fu_310_p1;

assign input2_buff_V_addr_2_gep_fu_184_p3 = i_5_cast_fu_310_p1;

assign input3_buff_V_addr_1_gep_fu_192_p3 = i_5_cast_fu_310_p1;

assign input4_buff_V_addr_1_gep_fu_200_p3 = i_5_cast_fu_310_p1;

assign input5_buff_V_address0 = i_5_cast_fu_310_p1;

assign input6_buff_V_address0 = i_5_cast_fu_310_p1;
